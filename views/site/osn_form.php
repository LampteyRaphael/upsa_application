    ...
    <div class="form-content animate-fade" style="animation-delay: 0.1s">
        ...
        = Alert::widget() ?>
                    ...
                    <!-- < $form = ActiveForm::begin([
                        ...
                        'action' => Yii::$app->urlManager->createUrl(['/site/osnform'])
                    ]); ?>
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            < Html::submitButton('Sign Up', [
                                ...
                                'data-loading-text' => '<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Processing...'
                            ]) ?>
                        </div>
                    </div> -->
